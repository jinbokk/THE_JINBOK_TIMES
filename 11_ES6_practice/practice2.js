...
// let over20Letter = names.some((item) => {return item.length > 20})
// console.log(over20Letter)
// // 또는,
// console.log(names.some((item)=>item.length>=20))

// let justName = names.map((item)=>{return item.split(' ')[0]})
// let pInclude = justName.some((item)=>{return item.includes("p")})
